...
def main():
    ...
    noob_maps_list = ['surf_ace_fix,', 'surf_aircontrol_ksf,', 'surf_akai_final,', 'surf_amplitude_light,', 'surf_and_destroy,',
                      'surf_annoyance_njv,', 'surf_autism,', 'surf_aweles,', 'surf_beginner,', 'surf_borderlands,',
                      'surf_calycate2,', 'surf_calycate_csgo,', 'surf_classics,', 'surf_colours,', 'surf_colors_beta1,',
                      'surf_colum_up,', 'surf_delusional_,', 'surf_derpis_ksf,', 'surf_eclipse,', 'surf_ethereal,',
                      'surf_forbidden_ways_ksf,', 'surf_funhouse_njv,', 'surf_grassland,', 'surf_how2surf,',
                      'surf_hurrr,', 'surf_kitsune,', 'surf_kz_protraining,', 'surf_leet_xl_beta7z_,',
                      'surf_legends_lite_gfl,', 'surf_lessons,', 'surf_life_of_duck_go,', 'surf_lullaby_ksf,',
                      'surf_lux,', 'surf_me,', 'surf_mesa,', 'surf_minuet_v1p,', 'surf_mom,', 'surf_neo_njv,',
                      'surf_network_2008_final,', 'surf_newb_hazard_r1,', 'surf_noob,', 'surf_olympics_sns,',
                      'surf_oma,', 'surf_pox,', 'surf_prelude_ksf,', 'surf_presmon_fix,', 'surf_prime_time_r3vamp,',
                      'surf_rebel_resistance_njv,', 'surf_Rebel_scaz_njv,', 'surf_reprise,', 'surf_rookie,',
                      'surf_simpsons_go_rc2,', 'surf_spacejam,', 'surf_sundown_njv,', 'surf_the_gloaming,',
